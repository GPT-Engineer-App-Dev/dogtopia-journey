...
const Index = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-blue-100">
      <h1 className="text-4xl font-bold mb-6 flex items-center text-blue-800">
        <Dog className="mr-2 text-blue-700" /> All About Dogs
      </h1>
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-blue-50 p-6 rounded-lg shadow">
          <h2 className="text-2xl font-semibold mb-4 text-blue-800">Man's Best Friend</h2>
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-800">Characteristics</h3>
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-800">Popular Breeds</h3>
